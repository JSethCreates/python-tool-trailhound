# TrailHound v4.7 - Added HTTP server for image serving
import webview
import subprocess
import requests
import os
...
def start():
    api = Api()
    window = webview.create_window('YouTube Viewer/Downloader - TrailHound v4.7', 'index.html', width=2300, height=1300)
